...
# Шлях НЕ хардкодимо: скрипт лежить у <проєкт>\docs, тому корінь = батьківська тека.
# Хардкод був причиною локальних правок на ноуті магазину, а ті правки згодом
# заблокували git pull і зламали кнопку «Оновити бота» (04.08.2026).
